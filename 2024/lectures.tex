...
the optical depth is defined as
 ...
 \item We did the example of ozone absorption in the stratosphere and found that all solar photons with wavelength below about 300 nm are absorbed by dissociating ozone.
...
% So the optical depth equals 1 when $z=28$km and by the time $z=15$km (the height mentioned in the book, well above the troposphere), the optical depth has risen to 5, so the flux has dropped by a factor of $e^{-5}=0.004$. 
 This, and other forms of absorption lead to Fig.~\rf{Solar-irradiance-spectrum-above-the-atmosphere-and-at-the-surface-prepared-by-Robert-A}.
...
\Spng{tau}{Optical depth vs. height for different $\kappa$.}
\item A slightly more relevant quantity for large optical depth from optical depth from the top: i.e., what is the optical depth a photon at height  $z$ experiences as it leaves the atmopshere. Very high up, this will be small, but as  $z$
