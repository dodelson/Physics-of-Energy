...
{\bf The bottom line is that any forcing will be met with a temperature change given by
\be
\Delta T = \frac{F}{3.2\,W/m^2}\, K.
\ee
What is the forcing if we double the $CO_2$ abundance?}
\bei
...
The sign is positive because less radiation gets out.
...
\item
In so doing, we emit 10 GT of carbon every year (Fig~\rf{emissions}). This is often reported in units of parts per million. The conversion factor is
\be
