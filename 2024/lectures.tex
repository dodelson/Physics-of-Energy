...
\bee
\item Global Energy Production and Use: 600 EJ ($10^{18}$J) were produced in 2023, about half of which was {\it final}, consumed by end users. About 80\% of that is fossil fuels, which emit carbon dioxide. US uses about 100EJ/year, steady over 2 decades; China, rising, now more than the US; India about 30EJ/year but rising fast. {\bf First Point:} Energy consumption, see figure~\rf{ec}. Over industrial history, we have used about 20,000 EJ.
\Spng{ec}{Global Energy consumption in EJ}
\exercise{Suppose we continue using 600 EJ every year. How much more energy will be used by 2050? Answer: 16,200 EJ}
\item $CO_2$ Emissions: 35-37 Gigatonnes of $CO_2$ every year for the past few years (covid dip from 37 to 35), gradual growth as shown in Fig.~\rf{co2gr}
\Spng{co2gr}{Emissions of $CO_2$ in units of GtC. The emissions roughly go as $3+7/60*(y-1960)$, Integrating that leads to roughly 400GtC, which is close to the actual value of 475 GtC.}
\bei
...
\item The ratio, 10 GtC/$6\times 10^{20}$J, is called the green house gas intensity, about 20 grams per MJ. Note from Fig.~\rf{ghgi} that this has come down about 15\% over the past 60 years, due to less reliance on fossil fuels.
\Spng{ghgi}{GHGI as a function of time.}
\exercise{Using your result from above, how much more $CO_2$ will we have emitted by 2050? Answer: 270GtC}
\eei
\item $CO_2$ in the atmosphere; about half of the $\sim500$ GtC emitted remains in the atmosphere; the rest is absorbed mostly by oceans.
\Spng{co2atm}{Carbon dioxide measurements in the atmosphere.}
\bei
\item We have been doing this for about 100 years, starting at about 1 and only recently leveling off at about 10. 
\item In total, we have emitted 475 GtC
\item About half of this remains in the atmosphere, and indeed, the amount of carbon in the atmosphere has increased from a little above 600 GtC to about 900 GtC as shown in Fig.~\rf{co2atm}.
\exercise{Assuming previous results, what will be the ratio of $CO_2$ in the atmosphere in 2050 compared to the preindustrial value of about 600GtC? Answer: 1.95, about 2}
\eei
\item Impact of $CO_2$ on the global temperature. Compared to the temperature in about 1960, the temperature has increased as indicated in Fig.~\rf{TA_CO2}. There is a formula we will derive: 
\be
\Delta T = 2.3K\,\log_2\left(\frac{c}{c_0}\right)\eql{mainresult}\ee
...
\exercise{What will the temperature anomaly be in 2050 in Farenheit and Celcius? Answer: 2.3 C, 4.14F}
\eee
...
%\ee}
\example{OLD: Rotational energy of tires in a car: 4, suppose each of which has all its mass $m$ at $R$ from the center. But the angular speed is $v/R$, so\be
...
In 3D, this gets multiplied by 3.
%\be
...
%\frac{3Nk_BT}{2}.
%\eea
%If we had done this in 1D, we would have gotten $k_BT/2$. 
In general, the variance of any one component of the velocity is $k_BT/m$, so in an isotropic equilibrium situation, there is a factor of 3. 

\example{5.1: How much energy does it take to heat the monatomic gas argon in the atmosphere by 1K?
\bee 
\item Mass of Atmosphere: 
\be\rho=1.2 e^{-z/H} kg/m^3
\ee
with $H=8.5km\ll R_\Earth$. So,
\be
M = \rho_0 4\pi R_\Earth^2 \int_0^\infty e^{-z/H} = \rho_0 4\pi R_\Earth^2H
\ee
Taking $R_\Earth=6.37\times 10^6$m leads to $M=5.2\times 10^{18}$kg. 
...
%\lsection{Pressure, Energy Conversion, and Heat Capacities}
...
%c_P=\frac{2.5\times 1.38\times 10^{-23} J/K}{4\times 1.67\times 10^{-27} kg},\ee which is indeed 5.2 kJ/K/kg.
 ...
 {\it Latent Heat:} This is the amount of energy required to change the phase of a substance: e.g., a solid is a lower energy state than a liquid (more tightly bound), so you need to addd energy to transform it into a liquid. This energy is called latent heat. E.g, for ice to water it is equal to 334 kJ/kg. %This makes sense: roughly we expect the energy connecting the atoms in a solid to be of order 5 eV. So the energy per molecule should be of order
%\be
%\frac{\Delta E_{Binding}}{\mass} \sim \frac{5\, eV}{18\times1.67\times 10^{-27}\, kg} =.\ee
Near a phase transition, the temperature will not rise as heat is added; rather the bonds will be broken. So it is called latent heat, as opposed to sensible heat (when the temperature does rise).
...
%We can now return to the heat capacity. 
...
More generally, we can %turn the plot in Fig.~\rf{dof} into 
...
At what temperature does the transition occur? I.e., what temperature corresponds to $k_BT\simeq \evib$?
\be
T = \frac{\evib}{k_B} \simeq \frac{0.08 \ eV}{eV/11605 K}. \simeq 900K.\ee
...
Final Notes:
\bei
\item Similar arguments apply for rotational degrees of freedom, but because their energies are so much smaller, these degrees of freedom are almost always excited.
\item Electronic degrees of freedom are excited only in very hot regions (e.g., stars)
\item The book argues that \ec{bare} is a derivation of the occupation number of particles in the given energy state
\eei
...
Derive Stefan-Boltzmann law, which governs emission from an object in thermal equilibrium.
\bee
...
\be
\Delta x \Delta p >\sim h = 2\pi\hbar.\ee
...
\be
I_\odot = \frac{L_\odot}{4\pi R_{\rm orbit}^2} = 1366W/m^2.\ee
using $R_{orbit}=1.5\times 10^8$km. 
...
\be
T_\Earth = T_\odot \, \left(\frac{R_\odot}{2R_{orbit}}\right)^{1/2}=290K\ee
...
%
%\lecture{Internal Energy Revisited}
...
\lsection{Overview}
\bei
\item Current capacity is about 400 GW (compared to 15TW required), so currently about 3\% of power generated, about 10 percent of electricity generated.
...
\group{How much energy can be produced by 1 kg of $^{235}$U? Each decay produces about 235 MeV, and each atom weighs $235\times 1.67\times 10^{-27}$kg. So, 1kg contains $1/(235\times 1.67\times 10^{-27})$ atoms, each of which produces $235$ MeV, so 1 kg produces $.6\times 10^{27}$ MeV, which corresponds to $.6\times 10^{27}\times 10^6 \times 1.6\times 10^{-19}$ J/eV, or about $10^{14}$J. Typically these plants are only about 33\% efficient so 1kg  can generate about $3\times 10^{13}$J per year. Compare this to total usage: $6\times 10^{20}J$.}
...
\item Getting say 10\% of current 15 TW then would require $1500\times 200=3\times 10^5$ tonnes (300kt) mined per year. This is a larger rate than currently (50kt) so seems unlikely. %If we double that, we could expect 100kt/year, which would lead to 500GW of nuclear power per year.
Even if we got that much, total resources are uncertain but rough estimates put it at $1-4\times10^7$ tonnes [with the upper range costing more to mine], which  would last a hundred years if we could extract it at a higher rate than today, and even that produces only 10\% of our needs.
\eee
...
\item Very rough estimate:   the difference between the potential at its peak and $Q$ is proportional to $V_0-E$, call that difference $\Delta$. Then
\be
\kappa = \sqrt{2m\Delta/\hbar^2}.\ee
The length of the barrier separating the spherical state to the (lower energy) elongated state is $L$. 
Estimate the barrier as the Coulomb barrier, so that 
\be
...
\be
 ...
 So the argument of the exponential is roughly
 \be
 2\kappa L \simeq Z^2\alpha \sqrt{\frac{8mc^2\Delta}{Q^2}}.\ee
...
% &=& 100
% \eea
 enough to extend the lifetime to much longer than the age of the universe. The factor before the square root is of order 100, and the factor inside is greater than 1 (about $(8*200*10^3*6/200^2)**.5\sim 15$, so the lifetime can be $10^{-20}\times e^{100}$, considerably longer than the age of the universe.
\eee
...
\Spng{balance3}{Power per log wavelength per area incoming on the Earth from the Sun and outgoing.}
...
Account for the fact that roughly radiation is released from high up in the atmosphere and that 70\% of solar radiation gets through to Earth to get Fig.~\rf{balance3}.
...
The density of ozone ($O_3$) is $2-5\times10^{18}m^{-3}$ in a band with a width of about $\Delta z \simeq 20km$ in the stratosphere.
...
\lsection{Fundamental Considerations for the Wind}
\bei
\item
...
\item 
The direction of $\vec v$ for different orientations of the pressure gradient is depicted in Fig.~\rf{geo1}. In the Northern hemisphere, perpendicular to the left of the pressure gradient, or along the lines of constant pressure, {\it isobars}.
...
%\item \be
%\Delta z = H \ln\left(\frac{P_2}{P_1}\right).\ee
...
%\item Air over the ocean at the equator to rise, then get pushed towards the poles. Eventually, when it becomes much colder than surrounding air, it will drop.
...
\eee
%\item The land masses induce vorticity so wind blows north on the western side of the ocean and and south on the eastern side (p. 524). 
...
\old{
\lsection{Adiabatic vs. Isothermal Pressure}
...
%\item Energy Balance III: Latent and Sensible Heat 
\item Radiative Transfer
...
Note that the temperature of the atmosphere is lower than the surface temperature by a factor of $2^{1/4}$, so it is equal to 255K, as shown in Fig.~\rf{albedoatmos}.
\Spng{albedoatmos}{Emission/absorption accounting for albedo plus single layer of atmosphere.}
 If we take the lapse rate to be the observed lapse rate in the atmosphere $6.5K/km$, this temperature difference of 48K would correspond to a height of 7 km.
...
\lsection{Atmosphere}
Apply this to the atmosphere:
\bei
 \item We did the example of ozone absorption in the stratosphere and found that all solar photons with wavelength below about 300 nm are absorbed by dissociating ozone. This, and other forms of absorption lead to Fig.~\rf{Solar-irradiance-spectrum-above-the-atmosphere-and-at-the-surface-prepared-by-Robert-A}.
 \Spng{Solar-irradiance-spectrum-above-the-atmosphere-and-at-the-surface-prepared-by-Robert-A}{Solar radiation as a function of wavelength.}
...
\item Until the top of the troposphere, the temperature decreases linearly with the lapse rate $\Gamma\simeq 6.5K/$km. After that, in the stratosphere, the temperature rises because of the heat released when ozone and other molecules are dissociated by very short wavelength sunlight. This leads to the layers in Fig.~\rf{tempvsz}.
\Spng{tempvsz}{Temperature as a function of height in the atmosphere.}
\item The density falls off exponentially (not exactly, but the 3rd tutorial will show that it's close) so
\bea  \tau (z_0,z) &=&
n_0 \sigma \int_0^z dz' e^{-z'/H} \vs
&\equiv& \kappa H\left(1-e^{-z/H} \right)\eea
where $H=8.5$km and $z_0$ is the surface.
\item Fig.~\rf{tau} shows how the optical depth varies with height for different values of $\kappa$.
\Spng{tau}{Optical depth from the surface to height $z$ vs. height for different $\kappa$.}
\item In the optically thin limit, this is all you need: a faction $1-\tau$ of OLR from the Earth escapes to the atmosphere.
\item In the optically thick limit, it is more complicated: none of the OLR from Earth escapes. The first term in \ec{rtan} goes away. The second term survives: this tells us that radiation is emitted from the atmosphere higher up. How much radiation is emitted is given by the full integral: radiation from lower $z$ has less chance of escaping. Radiation from very high up is more likely to escape. 
\item An approximation is that all of the radiation is emitted from the height at which $\tau(z,\infty)=1$. 
So, we want to ask: what is the optical depth a photon at height  $z$ experiences as it leaves the atmosphere: $\tau(z,\infty)$? Very high up, this will be small, but as  $z$
  decreases, eventually it will reach 1. This is roughly the place from which photons of this wavelength are emitted. This is shown in Fig.~\rf{tautop}.
  \Spng{tautop}{Optical depth from $z$ to infinity.}
  \item The height at which this rises to one defines the height of release:
\be
1\equiv   \kappa He^{-z_{release}/H} =1\rightarrow z_{release} = H\ln(\kappa H) .\ee
%\item We know what the density of air is at the surface, so dividing by the mass of a typical air molecule we get
%\be
%n_0 = \frac{1.25}{1.67\times 10^{-27} \times 29} = 2.6\times 10^{25} m^{-3}.\ee
%As an example, the cross section of $CO_2$ at 15 microns is $3.7\times 10^{-23}m^2$, and the density of $CO_2$ is $4.2\times 10^{-4}n_0$, $\kappa=0.4/m=400/km$.
%\item To determine the emission above the stratosphere at 50 km, take
%\be
%\tau(\infty) - \tau(50 km) = \kappa H e^{-50km/H} = 0.0028 \kappa H.\ee
%So at the peak of the line, no photons get out until they get above the stratosphere, but almost all other wavelengths escape well before the top of the stratosphere, and in most cases the tropopause.
\item In the region of the 15 micron line, Fig.~\rf{co2flux} shows the solution: for large $\kappa$, basically, emissions are at the low temperature at the top of the tropopause.
\Spng{co2flux}{Impact of absorption and emission for different opacities in the region of the 15 micron line.}
\item This leads to the OLR above the tropopause as shown in Fig.~\rf{IR_emission_in_current_greenhouse_levels}.
\Spng{IR_emission_in_current_greenhouse_levels}{OLR as a function of wavelength.}
%
%\be
%\frac{dP}{dz} = -g\rho = -\frac{gP}{RT}
%\ee
%where $R=k_B/m_{air}$. Solving this up into the tropopause leads to
%\be
%P(z) = P_0\,\exp\left\{ -\frac{g}{R}\int_0^z \frac{dz'}{T_0-\Gamma z'} \right\}
%\ee
%or
%\be
%P(z) = P_0\,\left( 1 - \frac{\Gamma z}{T_0}\right)^{g/R\Gamma}.
%\ee
%Note that since $H=RT_0/g$, this is equal to the isothermal example we have covered but actually the pressure drops a bit faster in this case.
%\item The density tracks the pressure so falls also faster than exponential into the stratosphere. By the top of the stratosphere, there is essentially no absorption takes place above the stratosphere and in fact most OLR is free above the tropopause.
%\item This leads to the OLR above the tropopause as shown in Fig.~\rf{IR_emission_in_current_greenhouse_levels}.
%\Spng{IR_emission_in_current_greenhouse_levels}{OLR as a function of wavelength.}
\eei


%\lecture{Radiative Transfer in the Atmosphere}
%
%Recall:
%\bei
%\item Until the top of the troposphere, the temperature decrease linearly with the lapse rate $\Gamma\simeq 6.5K/$km. After that, in the stratosphere, the temperature rises because of the heat released when ozone is dissociated by very short wavelength sunlight. This leads to the layers in Fig.~\rf{tempvsz}.
%%\Spng{tempvsz}{Temperature as a function of height in the atmosphere.}
%\item The density falls off exponentially 
%\be
%\frac{dP}{dz} = -g\rho = -\frac{gP}{RT}
%\ee
%where $R=k_B/m_{air}$. Solving this up into the tropopause leads to
...
%P(z) = P_0\,\left( 1 - \frac{\Gamma z}{T_0}\right)^{g/R\Gamma}.
%\ee
%Note that since $H=RT_0/g$, this is equal to the isothermal example in the small $z$ limit we have covered but actually the pressure drops a bit faster in this case, as shown in Fig~\rf{pisoad}.
%\Spng{pisoad}{Pressure under two limiting temperature conditions.}
%\item The density tracks the pressure so falls also faster than exponential into the stratosphere. By the top of the stratosphere, there is essentially no absorption takes place above the stratosphere and in fact most OLR is free above the tropopause.
%\eei
%

\lecture{Forcing and Feedbacks}

\lsection{Impact of $CO_2$ Doubling}

What happens if we double the $CO_2$ abundance?
\bei
%\item Fig.~\rf{co2doubling} shows  the impact of doubling the concentration.
%\Spng{co2doubling}{Impact of doubling the $CO_2$ concentration for different opacities..}
\item Fig.~\rf{olr} shows the impact on OLR as a function of wavelength near the 15 micron line.
\Spng{olr}{Outgoing long wavelength radiation as a function of wavelength}
\item Integrating over all wavelengths in Fig.~\rf{olr} leads to a difference when the CO$_2$ abundance double from 280 to 560 ppm of 3.76W/m$^2$. %That is, when the ghg concentration doubles, the OLR will decrease by 3.3 W/m$^2$. 
\item The deficit is logarithmically dependent on the concentration as indicated in Fig.~\rf{olrlog}:
\be
F = 3.76\log_2(c/c_0) W/m^2.\eql{log}\ee 
The sign is positive because less radiation gets out. Here $F$ stands for {\it forcing}.
...
The bottom line is that any forcing will be met with a temperature change given by
\be
\Delta T = \frac{F}{3.2\,W/m^2}\, K.
\ee
...
\item But then this temperature change leads to a new forcing $F_1=\lambda \Delta T_0$. Note that $\lambda$ is a bit different than $\lambda_0$. The latter governs how the temperature changes for a given forcing. When the forcing is positive, the temperature change is also positive, so $\lambda_0$ is negative. The former governs how much a given temperature change leads to other forcing effects. E.g., if the temperature rise melts the ice, then the albedo will go down, leading to {\it positive} forcing, and therefore positive $\lambda$. 
...
{\bf From Energy to Temperature Increase}
\bei
\item Human produce and use $6\times 10^{20}J$ of energy every year.
\item
In so doing, we emit 10 GT of carbon every year. This is often reported in units of parts per million. The conversion factor is
\be
1 {\rm ppm} =2.13 \,{\rm GigaTonnes\, of\, Carbon}.
\ee
So 10 GtC = 4.7 ppm every year.
...
\item The {\it greenhouse gas intensity} is the ratio of carbon produced per energy use. It is
\be
GHGI = \frac{10GtC}{6\times 10^{20} J} = \frac{10^{16} g}{6\times 10^{14} MJ} = 17 g/MJ.\ee
...
\item The additional $CO_2$ increases the temperature by an amount
\be
\Delta T = 2.3\log_2(c/c_0)\eql{cot}
.\ee
You can check this by looking at the graphs since 1960, as shown in Fig.~\rf{TA1_CO2}.
\Spng{TA1_CO2}{The predicted rise in temperature as a function of $CO_2$ abundance using \ec{cot} since 1960 and the observed temperature increase.} 
\item We can turn this into an equation for the expected rise in temperature as a function of energy use, using:
\be
c = c_0 + GHGI\times E \times 0.5
\ee
In units of ppm, this translates to
\be
c = 422\,ppm + 0.5 \frac{E}{6\times 10^{20} J}\, \frac{10 GtC}{ppm}\,ppm\ee
or
\be\frac{c}{280} = 1.5 + \frac{2.3}{280}\, \frac{E}{6\times 10^{20} J},\ee
Therefore,
\be \Delta T = 2.3K\,\log_2\left( 1.5+ \frac{2.3}{280} \frac{E}{6\times 10^{20} J} \right).\ee
\item The simplest estimate is we continue using the same energy year so $E/600EJ$ is just equal to the number of years from now. Then,
\be
\Delta T = 2.3K\,\log_2\left( 1.5+ 0.0082N\right).\ee
This predicts that in 2100, the temperature anomaly will be 2.5$^\circ$. This predicts that temperature anomaly will reach 2$^\circ$C in 40 years.
\Spng{1990}{1990 IPCC prediction}
\eei

\lecture{Summary: Energy Balance, Energy to Temperature Change}
...
\item This roughly traces the cross section, which is estimated as% via
\be
\sigma = s_0 e^{-r|k-k_0|}
\ee
...
\bei
\item Drag force on car
\item Hydro-storage converts potential to kinetic energy
\item When a photon with long wavelength is emitted from Earth and absorbed by a $CO_2$ molecule, the molecule jumps to an excited state. Only photons with specific energies can lead to a particular excitation. E.g., 15 micron line
\item When water in the ocean absorbs solar energy, it tends to evaporate more since the energy in the gas state is higher than the energy in the liquid state
\item When the air condenses into clouds, it releases energy since it drops to the lower energy liquid state
\eei
\item Equilibrium
\bei
\item Monatomic Gas: Maxwellain distribution governed by temperature $T$, leads $\Delta Q=C\Delta T$ with $C=3/2Nk_B$
\item $k_BT$ governs typical energy of atoms 
\item Diatomic Gas can have vibrational and rotational levels as well, so as $k_BT$ gets larger than rotational splitting 2 more DOF and $3/2\rightarrow 5/2$. At even higher $T$, $7/2$.
\item All materials in equilibrium radiate photons with a characteristic shape:
\be
B_\nu(T) = \frac{2h\nu^3}{c^2}\, \frac1{e^{h\nu/k_BT}-1}\ee
with the typical frequency determined by the temperature (peaking near $\nu\sim k_BT/h$)
\eei
\item Rates of Interactions
\bei
\item Air resistance: energy transfered per time
\item Optical depth for a photon is given by $\int dz n\sigma$: important for GHG and for UV absorbtion
\item Rates for processes in nuclear reactors depend on speed of nuclei, e.g.
\item Cross sections are not geometric and are very important in governing how often something happens
\eei
\item Gravity and Pressure
\bei
\item Pressure is force per area
\item Ideal Gas Law
\item Hydrostatic Equilibrium: $dP/dz=-\rho g$. Comes from the force of a bouncing ball
\item Leads to pressure profile. E.g., for $T=T_0-\Gamma z$,
\bea
...
&=&
P_0 \exp\left\{ -\frac{1}{H}\,\int _0^z\,\left( \frac{dz'}{1- \frac{\Gamma z'}{T_0}}\right)\right\}
\vs
&=& P_0 \left(1 -  \frac{\Gamma z}{T_0}\right)^{T_0/\Gamma H}.
\eea
\eei
 \item Taylor Expansion:
\be\left(1 -  \frac{\Gamma z}{T_0}\right)^{T_0/\Gamma H }\simeq 1-z/H\ee
exactly the same as the isothermal case where $P=P_0e^{-z/H}$.
\item Heat Transfer
\bei
\item Conduction
\item Convection: derived by balancing gravity and pressure
\item Radiative Transfer
\eei
\item Quantum mechanics dictates that bound states have discrete, or {\it quantized}, energy levels. 
\bei
\item Particle trapped in a box gives estimate of nuclear energies: $E\sim \hbar^2\pi^2/2mL^2$
\item $CO_2$ has discrete vibrational, rotational levels
\item Nuclei have specific energies or binding energies
\item  Hierarchy in molecules: electronic, vibrational states, and rotational states
\eei
\item Rotational Energy and Motion
\bei
\item Angular Momentum: $E=L^2/2I$ together with $L\sim\hbar$ leads to estimates of rotational energy levels
\item Coriolis Force dictates horizonal flow of heat across the globe
\eei
\item Equilibrium maintained on Earth
\bei 
\item Energy Balance: Solar energy in is balanced by OLR
Fig.~\rf{earthbalance} summarizes the balance.  
\Spng{earthbalance}{Balance}
\item Forcing leads to change in temperature
\eei
\eee
