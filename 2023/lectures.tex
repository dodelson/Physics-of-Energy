...
\example{Consider Example 5.2 in the book. One liter ($10^{-3}m^3$) of a mona ideal gas at T=273K, $p=10^5$Pa. 
\bei
\item
...
=  150 J.\ee
\item How much work is done to reduce the volume by a factor of 2? 
\be W = P*V/2 = 50J.\ee
\item What is the new internal energy, temperature, and pressure?
\be U_{new}=U_{i}+W=200J.\ee
The new temperature is larger than the initial by 200/150=4/3, so is equal to 363K
The pressure is now $Nk_BT'/V'= P_{old} \times 8/3= 2.67\times 10^{5}$Pa.
\item When the temperature cools to external temperature at 273, so drops by 4/3, the pressure will similarly drop to twice the initial pressure. All the work done to compress the volume has been lost to the heat that escapes as it cools.
\eei}
