...
\bee
\item $k$ has dimensions of $E/(t\times L\times K)$. Air has $k=0.026$ W/mK, while window glass has $k=1$ W/mK, at fixed temperature difference, more heat has to flow to maintain this difference if glass separates the two regions than if air does. %meaning that more energy is required to heat up a region on the other side of glass than if there were no glass partition.
...
\example{Consider Pittsburgh and Atlanta, separated by about 1200 km. On a given day in January, the temperature difference is $26^\circ$. How long would it take conduction to equilibrate these? Heat flows at a rate of 
\be
q=0.026\times \frac{26}{1.2\times 10^6} W/m^2=5.6\times 10^{-7} W/m^2. \ee
So a square region in front of Pittsburgh that is 10km high and wide will receive 56 W of heat from Atlanta. This is less than a light bulb.}
