...
the optical depth is defined as
 ...
 \item This dissociation leads to heat (since energy is released) and therefore above the troposphere at $\sim10$km, the temperature starts rising.
...
\vs
&=&P_0 \exp\left\{ -\frac{k_B}{mg}\,\int_0^z dz' (T_0-\Gamma z') \right\}\vs
&=&
P_0 \exp\left\{ -\frac{z}{H_0}\,\left( 1- \frac{\Gamma z}{2T_0}\right)\right\}
\eea
\item This also impacts the density profile:
\be
\frac{\rho}{\rho_0} = \frac{P}{P_0}\,{T_0}{T}\ee
This leads to the profiles shown in Fig.~\rf{isoad}.
\Spng{isoad}{Profiles of pressure, density, and temperature in the adiabatic case, contrasted with the exponentially suppressed isothermal case.}
\eei
