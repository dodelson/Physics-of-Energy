...
\item Rate of energy across a surface S: \be\frac{dU}{dt} = \int_S d\vec S\cdot \vec q\eql{cont}\ee This is a form of the continuity equation: the change in time in the internal energy in a region is equal to the flux of energy through the surface bounding that region.
\eei
...
\be
-\left(1-\frac{1}{\gamma}\right)\, \frac{T}{P}\, \frac{dP}{dr} > -\frac{dT}{dr}
\ee
...
Useful sites:
\bee
\item\href{Cimateifomatics}{http://www.climateinformatics.org/}
...
Some facts:
\bee
\item Human emit 10 GTon of carbon every year (Fig~\rf{emissions})
\Spng{emissions}{Global Annual CO$_2$ emissions in tons of carbon.}
\item This has led to an increase of 400 GTon since pre-industrial but only half of that has remained in the atmosphere (see Figs.~\rf{co2} and \rf{cum})
...
\item According to 34.37, this corresponds to a forcing of about 2W/m$^2$.
\item Without feedbacks, since $\lambda_0=-3.2$ W/m$^2$ K (34.32), the temperature increase due to this amount of carbon would be 0.6K.
