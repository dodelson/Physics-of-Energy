...
\lecture{Time Dependent Conduction}
...
\item Since density is inversely proportional to temperature, this means that typically hot air will rise.
\item 
...
c_vdT=PVd\rho/\rho
.\ee
For an ideal gas $P=\rho c_v T$, do $dP=d\rho c_v T + \rho c_vdT$ so,
\be
c_v dT = \frac1{\rho}\,\left[ dP - d\rho c_v T\right]
\ee
Therefore,
\be
...
\ee, the solution to which is $P\propto \rho^\gamma$.}
