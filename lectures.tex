...
Introduce $\vec\omega$ (points along axis of rotation $(v=\vec r\times \vec\omega)$ to be used when discussing Coriolis forces in ocean/wind chapters.
...
\subsection{Ground Temperature Seasonal Variation}
Use the fact that
...
\bei
\item Start with Centrifugal Force
\item Figure 27.4
\item Throw something north: frequency increases to keep angular momentum constant
\item Use 27.3 to show same increase in frequency
\item Use 27.3 to show $F_{hc} = 2m\omega\sin\lambda \vec v\times\vec n$
\eei

\section{Surface Currents}
\bei
\item Iceberg at constant velocity at an angle to the direction of the wind
\item Solve eqns of motion to get Ekman Spiral: drift at right angle to wind
\item Mass Transport
\eei
...
\section{Properties}
\bee
\item Geostophic winds (Box 28.1)
