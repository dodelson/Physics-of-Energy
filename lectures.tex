...
\item Why do neutrons speed up the process?
\eee
We have a model for binding energy.
...
\example{Decay of $^{235}$}

\lsection{Lifetimes}

\bee
\item Surface area vs. volume leads to spherical nuclei
\item This breaks down for large $A$ when Coulomb force favors elongated nuclei
\item Figure with barrier
\item QM decay rates with barrier
\eee
